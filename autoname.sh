...
addr_alias=("pl." "pkwy." "blvd." "ct." "ln." "rd." "dr.")
addr_block=$((RANDOM % 10000))
addr_name_common=("jefferson" "chapel" "university" "lake" "lincoln" "central" "main" "victoria" "college" "hamilton" "bell" "baker" "clark" "martin" "adams" "forrest" "magnolia" "oak" "willow" "riverside" "juniper" "cedar" "ridge" "maple" "king" "walnut" "oxford" "park" "washington")
...
randnm=${addr_name_common[$RANDOM % ${#addr_name_common[@]}]}
randsn=${addr_alias[$RANDOM % ${#addr_alias[@]}]}
...
echo "Address:    -$addr_block $randnm $randsn"
echo "City:       -$city"
echo "State:      -$state"
